...
function MobileOrHome() {
  const mobile = useIsMobile()
  return mobile ? <MobilePage /> : <PageLayout><Home /></PageLayout>
}
...
function AppInner() {
  ...
  return (
    <>
      {!isMobile && <Topbar wsStatus={status} sidebarOpen={sidebarOpen} onToggle={() => setSidebarOpen(p => !p)} />}

      <Routes>
        <Route path="/" element={<MobileOrHome />} />
